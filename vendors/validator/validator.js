...
var validator = (function($){
    ...
    */
    tests = {
        ...
        // 'linked' is a special admin case for inputs which their values should be equal to each other (ex. confirm email or retype password)
        linked : function(a,b){
            if( b != a ){
